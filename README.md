...
1. **Внесение информации об учащихся:**
   ...
   - Данные должны храниться в JSON-файлах.
...
8. **Работа с JSON-файлами:**
   - Данные об учащихся должны храниться в JSON-файлах.
   - Реализовать функции для чтения и записи JSON-файлов.
...
4. **Файловая структура:**
   ...
   - **`data/`**: Папка для хранения JSON-файлов и Excel-файлов.
...
- **`data/`**: JSON-файлы и Excel-файлы.

##### **7.2. Основные модули**
  - Создание экземпляра Flask.
  - Обработки HTTP-запросов.
  - json, pickle, sqlite3, sys.
